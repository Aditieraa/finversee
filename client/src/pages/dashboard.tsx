          ...
          {!quickActionsOpen && (
            <div className="flex justify-start">
              ...
              >
                ...
                <span className="inline-flex h-7 w-7 transform rounded-full bg-white shadow-lg transition-transform duration-300 group-hover:shadow-xl ml-0.5 flex-shrink-0" />
              </button>
            </div>
          )}
        </div>
